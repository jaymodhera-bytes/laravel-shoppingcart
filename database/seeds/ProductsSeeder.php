...
class ProductsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('products')->insert([
            ...
            'photo' => 'https://i.ebayimg.com/thumbs/images/g/KxQAAOSwFNZW0u~T/s-l225.webp',
            'price' => 983.00
        ]);
...
• No returns, but backed by eBay Money back guarantee',
        ...
        DB::table('products')->insert([
            ...
            'description' => 'The device is in good cosmetic condition and will show minor scratches and/or scuff marks.',
            'photo' => 'https://i.ebayimg.com/images/g/XbAAAOSwo1Ze8aGS/s-l640.jpg',
            'price' => 129.99
        ]);
        ...
        DB::table('products')->insert([
            'name' => 'Mens Shoes',
            'description' => 'The device is in good cosmetic condition and will show minor scratches and/or scuff marks.',
            'photo' => 'https://i.ebayimg.com/thumbs/images/g/ijIAAOSwd01c~vpO/s-l225.webp',
            'price' => 129.99
        ]);
        ...
        DB::table('products')->insert([
            'name' => 'Jacket',
            'description' => 'The device is in good cosmetic condition and will show minor scratches and/or scuff marks.',
            'photo' => 'https://i.ebayimg.com/thumbs/images/g/hg8AAOSwAoFbarSF/s-l225.webp',
            'price' => 129.99
        ]);
        ...
        DB::table('products')->insert([
            'name' => 'Sunglass',
            'description' => 'The device is in good cosmetic condition and will show minor scratches and/or scuff marks.',
            'photo' => 'https://i.ebayimg.com/thumbs/images/g/thgAAOSwSTFe7xmj/s-l225.webp',
            'price' => 129.99
        ]);
